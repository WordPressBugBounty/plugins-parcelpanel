...
- Changed – Updated app name, logo, and UI elements for a fresher look.

- Note – All features, settings, and tracking data remain unchanged. No action is required on your part.
...
- Add – Integrations with WPC Product Bundles for WooCommerce
- Fix – Fixed some known issues
