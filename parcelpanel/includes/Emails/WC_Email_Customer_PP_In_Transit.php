...
class WC_Email_Customer_PP_In_Transit extends WC_Email_Shipping_Notice
{
    public function __construct()
    {
        ...
        $this->title       = __( 'ParcelWILL In transit', 'parcelpanel' );
        $this->description = __( 'ParcelWILL In transit emails are sent to customers when the shipment is on the way.', 'parcelpanel' );
